...
@Component({
  selector: 'app-template-vert-grouped',
  templateUrl: './template-vert-grouped.component.html',
  styleUrls: ['./template-vert-grouped.component.scss']
})
export class TemplateVertGroupedComponent implements OnInit, OnChanges, AfterViewInit {
